...
public class CustomDecoratedBarcodeView extends DecoratedBarcodeView{
    ...
    private CustomBarcodeView barcodeView;
...
//    private TextView statusView;
    ...
    public void stopThread(){
        viewFinder.stopThread();
    }

    /**
     * The instance of @link TorchListener to send events callback.
     */
    private CustomDecoratedBarcodeView.TorchListener torchListener;
    ...
    public CustomDecoratedBarcodeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        int scannerLayout = attributes.getResourceId(
                R.styleable.zxing_view_zxing_scanner_layout, R.layout.custom_zxing_view_zxing_scanner_layout);

        attributes.recycle();

        inflate(getContext(), scannerLayout, this);

        barcodeView = findViewById(R.id.zxing_custom_barcode_surface);
        ...
        viewFinder = findViewById(R.id.zxing_custom_viewfinder_view);
...
//        }
    ...
    public BarcodeView getBarcodeView() {
        return (BarcodeView) findViewById(R.id.zxing_custom_barcode_surface);
    }
...
//    }
    ...
    public void decodeSingle(BarcodeCallback callback) {
        barcodeView.decodeSingle(new CustomDecoratedBarcodeView.WrappedCallback(callback));
    }
    ...
    public void decodeContinuous(BarcodeCallback callback) {
        barcodeView.decodeContinuous(new CustomDecoratedBarcodeView.WrappedCallback(callback));
    }
    ...
    public void setTorchListener(CustomDecoratedBarcodeView.TorchListener listener) {
